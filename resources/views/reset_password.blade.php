...
<head>
    ...
    <title>{{ $action }} password - Water Billing System</title>
            ...
            <div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid>
                <div class="uk-width-1-1@m">
                    <div
                        ...
                        <h3 class="uk-card-title uk-text-center">{{ $action }} password</h3>
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="uk-margin">
                                <div class="uk-inline uk-width-1-1">
                                    ...
                                    <input class="uk-input uk-form-large @error('password') uk-form-danger @enderror"
                            ...
                            <div class="uk-margin">
                                <div class="uk-inline uk-width-1-1">
                                    <span class="uk-form-icon" uk-icon="icon: lock"></span>
                                    <input
                                        class="uk-input uk-form-large @error('password_confirmation') uk-form-danger @enderror"
                            ...
                            <div class="uk-margin">
                                <button
                                    class="uk-button uk-button-primary uk-button-large uk-width-1-1">{{ $action }}</button>
                            </div>
                        </form>
                    </div>
                </div>
