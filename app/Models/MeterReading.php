...
class MeterReading extends Model
{
    ...
    protected $fillable = ['meter_id', 'previous_reading', 'current_reading', 'month', 'bill', 'service_fee', 'monthly_service_charge_deducted', 'status', 'sms_sent', 'send_sms_at', 'bill_due_at', 'tell_user_meter_disconnection_on', 'actual_meter_disconnection_on', 'disconnection_remainder_sms_sent', 'disconnection_sms_sent'];
